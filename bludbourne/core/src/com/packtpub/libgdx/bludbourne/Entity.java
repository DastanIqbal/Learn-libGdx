...
public class Entity {
    ...
    public void setBoundingBoxSize(float percentageWidthReduced, float percentageHeightReduced) {
        ...
        //Need to account for the unitscale, since the map coordinateswill be in pixels
        float minX;
        float minY;
    ...
    private void loadAllAnimations() {
        ...
        _walkDownAnimation = new Animation<TextureRegion>(0.25f, _walkDownFrames, Animation.PlayMode.LOOP);
        _walkLeftAnimation = new Animation<TextureRegion>(0.25f, _walkLeftFrames, Animation.PlayMode.LOOP);
        _walkRightAnimation = new Animation<TextureRegion>(0.25f, _walkRightFrames, Animation.PlayMode.LOOP);
        _walkUpAnimation = new Animation<TextureRegion>(0.25f, _walkUpFrames, Animation.PlayMode.LOOP);
    }
